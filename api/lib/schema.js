...
export const Created = Type.Integer({
    description: 'The timestamp at which the resource was created'
});

export const Updated = Type.Union([Type.Null(), Type.Integer()], {
...
export const ExportResponse = Type.Object({
    ...
    format: Format,
    created: Created,
    expiry: Type.Integer({ description: 'The timestamp at which the export will expire' }),
    size: Size,
    status: Status,
    loglink: Loglink
}, {
