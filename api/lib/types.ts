...
function StringEnum<T extends string>(values: readonly T[], options: SchemaOptions = {}) {
...
function AnyObject(options: SchemaOptions = {}) {
...
// Static type helpers derived from the schemas above

export type StandardResponseType = Static<typeof StandardResponse>;
export type HealthResponseType = Static<typeof HealthResponse>;
export type CollectionResponseType = Static<typeof CollectionResponse>;
export type ListCollectionsResponseType = Static<typeof ListCollectionsResponse>;
export type CreateTokenResponseType = Static<typeof CreateTokenResponse>;
export type ListTokensResponseType = Static<typeof ListTokensResponse>;
export type DataResponseType = Static<typeof DataResponse>;
export type ListDataResponseType = Static<typeof ListDataResponse>;
export type DataHistoryResponseType = Static<typeof DataHistoryResponse>;
export type ErrorCountResponseType = Static<typeof ErrorCountResponse>;
export type ErrorListResponseType = Static<typeof ErrorListResponse>;
export type ErrorModerateResponseType = Static<typeof ErrorModerateResponse>;
export type JobErrorResponseType = Static<typeof JobErrorResponse>;
export type ExportResponseType = Static<typeof ExportResponse>;
export type ListExportResponseType = Static<typeof ListExportResponse>;
export type JobResponseType = Static<typeof JobResponse>;
export type ListJobsResponseType = Static<typeof ListJobsResponse>;
export type SingleJobsResponseType = Static<typeof SingleJobsResponse>;
export type SingleJobsCreateResponseType = Static<typeof SingleJobsCreateResponse>;
export type SingleDeltaResponseType = Static<typeof SingleDeltaResponse>;
export type SingleLogResponseType = Static<typeof SingleLogResponse>;
export type LevelOverrideResponseType = Static<typeof LevelOverrideResponse>;
export type ListLevelOverrideResponseType = Static<typeof ListLevelOverrideResponse>;
export type LicensesResponseType = Static<typeof LicensesResponse>;
export type RunResponseType = Static<typeof RunResponse>;
export type ListRunsResponseType = Static<typeof ListRunsResponse>;
export type RunStatsResponseType = Static<typeof RunStatsResponse>;
...
export type TileJSONResponseType = Static<typeof TileJSONResponse>;

export type CreateCollectionBodyType = Static<typeof CreateCollectionBody>;
export type PatchCollectionBodyType = Static<typeof PatchCollectionBody>;
export type CreateExportBodyType = Static<typeof CreateExportBody>;
export type PatchExportBodyType = Static<typeof PatchExportBody>;
export type CreateLevelOverrideBodyType = Static<typeof CreateLevelOverrideBody>;
export type PatchLevelOverrideBodyType = Static<typeof PatchLevelOverrideBody>;
export type CreateLoginBodyType = Static<typeof CreateLoginBody>;
export type ForgotLoginBodyType = Static<typeof ForgotLoginBody>;
export type ResetLoginBodyType = Static<typeof ResetLoginBody>;
export type CreateRunBodyType = Static<typeof CreateRunBody>;
export type PatchRunBodyType = Static<typeof PatchRunBody>;
export type CreateTokenBodyType = Static<typeof CreateTokenBody>;
export type CreateUserBodyType = Static<typeof CreateUserBody>;
export type PatchUserBodyType = Static<typeof PatchUserBody>;
export type ErrorCreateBodyType = Static<typeof ErrorCreateBody>;
export type ErrorModerateBodyType = Static<typeof ErrorModerateBody>;
export type PatchDataBodyType = Static<typeof PatchDataBody>;
export type PatchJobBodyType = Static<typeof PatchJobBody>;
export type ScheduleBodyType = Static<typeof ScheduleBody>;
export type SingleJobsCreateBodyType = Static<typeof SingleJobsCreateBody>;

export type DataHistoryQueryType = Static<typeof DataHistoryQuery>;
export type ErrorListQueryType = Static<typeof ErrorListQuery>;
export type GetLoginQueryType = Static<typeof GetLoginQuery>;
export type VerifyLoginQueryType = Static<typeof VerifyLoginQuery>;
export type ListDataQueryType = Static<typeof ListDataQuery>;
export type ListExportQueryType = Static<typeof ListExportQuery>;
export type ListJobsQueryType = Static<typeof ListJobsQuery>;
export type ListOrphanedJobsQueryType = Static<typeof ListOrphanedJobsQuery>;
export type ListLevelOverrideQueryType = Static<typeof ListLevelOverrideQuery>;
export type ListRunsQueryType = Static<typeof ListRunsQuery>;
export type ListUsersQueryType = Static<typeof ListUsersQuery>;
export type SingleLogQueryType = Static<typeof SingleLogQuery>;
